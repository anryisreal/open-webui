...
{#if loaded}
	<div class="gpthub-composer-shell w-full font-primary">
				...
				<div class="">
					...
					>
						...
						<div
							...
							class="gpthub-composer-card flex-1 flex flex-col relative w-full shadow-lg rounded-3xl border {$temporaryChatEnabled
